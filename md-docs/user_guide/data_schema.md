...
| RAG Session ID | METADATA | String | In multi-turn RAG Tasks it groups turns that belong to the same conversation. Required when the Task [Multi-turn](task.md#attributes) attribute is enabled. |
| RAG Turn ID | METADATA | Integer | In multi-turn RAG Tasks it is the order of the turn inside the session, starting at 0. Required when the Task [Multi-turn](task.md#attributes) attribute is enabled. |
...
| **OCR** | [plain text](https://github.com/ml-cube/ml3-platform-docs/blob/main/data-schema-templates/ocr_plain_text.json) - [with labels](https://github.com/ml-cube/ml3-platform-docs/blob/main/data-schema-templates/ocr_with_labels.json) |
| **RAG** | [single turn](https://github.com/ml-cube/ml3-platform-docs/blob/main/data-schema-templates/rag_single_turn.json) - [multi turn](https://github.com/ml-cube/ml3-platform-docs/blob/main/data-schema-templates/rag_multi_turn.json) |
| **Other** | [object detection](https://github.com/ml-cube/ml3-platform-docs/blob/main/data-schema-templates/object_detection.json) - [semantic segmentation](https://github.com/ml-cube/ml3-platform-docs/blob/main/data-schema-templates/semantic_segmentation.json) - [timeseries](https://github.com/ml-cube/ml3-platform-docs/blob/main/data-schema-templates/timeseries.json) |
