...
| Monitoring Target      | The [Monitoring Target](index.md#monitoring-targets) being monitored.                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| Monitoring Evaluation Metric | The [Evaluation Metric](index.md#monitoring-evaluation-metrics) being monitored                                                                                                                                                                                                                                                                                                                                 |
...
It is important to note that **Monitoring Target** and **Monitoring Evaluation Metric** are mutually exclusive. Both fields cannot be defined at the same time for a single event because they represent two different entities being monitored: the Monitoring Target refers to the primary object of monitoring (e.g., input, concept, error), while the Monitoring Evaluation Metric refers to a derived evaluation signal used to assess performance or quality. Since they operate at different conceptual levels, only one can be the focus of a single event.
